...
export const CarrouselItem6 = () => {
  ...
  return (
    <>
      {/* Mobile */}
      {/* <div className="w-full h-full bg-gray-600 lg:hidden">prueba</div> */}

      {/* Desktop */}
      <div
        className={`bg-[url(/src/assets/bg-image/bg-3.jpg)] bg-no-repeat bg-cover bg-opacity-10 bg-center justify-center flex-wrap w-full h-full flex`}
      >
